                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-10">
                                        <input class="form-control" type="text" placeholder="Judul Publikasi" id="Judul-Publikasi">
                                    </div>
                                </div>
                                <div class="mb-3 row">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-10">
                                        <input class="form-control" type="text" placeholder="Masukan nama penulis 1" id="Judul-Publikasi">
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    <label for="example-text-input" class="col-md-2 col-form-label">Penulis 2</label>
                                    <div class="col-md-10">
                                        <input class="form-control" type="text" placeholder="masukan jika terdapat penulis 2" id="Judul-Publikasi">
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    <label for="example-text-input" class="col-md-2 col-form-label">Penulis 3</label>
                                    <div class="col-md-10">
                                        <input class="form-control" type="text" placeholder="masukan jika terdapat penulis 3" id="Judul-Publikasi">
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    <label for="example-text-input" class="col-md-2 col-form-label">Penulis 4</label>
                                    <div class="col-md-10">
                                        <input class="form-control" type="text" placeholder="masukan jika terdapat penulis 4" id="Judul-Publikasi">
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    <label for="example-text-input" class="col-md-2 col-form-label">Penulis 5</label>
                                    <div class="col-md-10">
                                        <input class="form-control" type="text" placeholder="masukan jika terdapat penulis 5" id="Judul-Publikasi">
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    <label for="example-text-input" class="col-md-2 col-form-label">Penulis 6</label>
                                    <div class="col-md-10">
                                        <input class="form-control" type="text" placeholder="masukan jika terdapat penulis 6" id="Judul-Publikasi">
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    <label for="example-text-input" class="col-md-2 col-form-label">Semua Penulis</label>
                                    <div class="col-md-10">
                                        <input class="form-control" type="text" placeholder="masukan semua penulis" id="Judul-Publikasi">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-10">
                                        <input class="form-control" type="text" placeholder="jurnal/konferensi" id="Judul-Publikasi">
                                    </div>
                                </div>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-10">
                                        <input class="form-control" type="url" placeholder="Link Artikel" id="example-url-input">
                                    </div>
                                </div>
                                <div class="mb-3 row">
