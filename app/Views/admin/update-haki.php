                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-md-10">
                                            <textarea class="form-control" id="catatan" rows="3" name="abstrak" ><?= $oldHaki["abstrak"] ?></textarea>
                                        </div>
                                    </div>
                                    <div class="mb-3 row">
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-md-10">
                                            <textarea class="form-control" id="catatan" rows="3" name="catatan" ><?= $oldHaki["catatan"] ?></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
